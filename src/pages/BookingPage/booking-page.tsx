  ...
  const handleBook = async (fullName: string, phone: string, email: string) => {
    ...
    try {
      ...
      const response = await api.post(
        `/appointment/save?hospitalize=NO&full%20name=${fullName}&phone=${phone}&email=${userEmail}`,
        appointmentDate
      );
    ...
    <>
      <div className="booking-container">
        <div className="booking-main">
          <section className="booking-section">
            ...
            {account && (
              <div className="booking-inner">
                ...
                <div className="booking-attribute-container">
                  <div className="booking-attribute">
                    <BookingPetPicker value={pet} onChange={handlePetChange} />
                  </div>
                </div>
              </div>
            )}
          ...
          <section className="booking-section">
            ...
            <div className="booking-inner">
              ...
              <div className="booking-attribute-container">
                <div className="booking-attribute">
                  <BookingServicePicker onChange={handleServiceChange} />
                </div>
              </div>
            </div>
            <div className="booking-inner">
        ...
        <div className="booking-action">
          <button onClick={() => handleBook(fullname, phone, email)}>
            Confirm
          </button>
