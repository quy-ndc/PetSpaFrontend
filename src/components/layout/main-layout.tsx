            ...
            <div className="main-layout">
                <nav className={scrolled ? "scrolled" : ""}>
                    <div className="main-nav-left">
                        <Link to="/" onClick={() => handleOptionChange("home")}>
                            <svg
                                widths={50}
                                height={50}
                                x="0px"
                        ...
                        <div className="main-nav-left-action">
                            ...
                            <Link
                                ...
                                className={`service-option ${selectedOption === "service" ? "active-main-option" : ""
                                    }`}
                            >
                                Our Services
                            </Link>
                    ...
                    <div className="main-nav-right">
                        <Link to="/booking" className="nav-right-book-button">
                            <CalendarTodayIcon />
                            <span>Book now</span>
                        </Link>
                        <div className="nav-right-dropdown">
                            ...
                            {dropdownVisible && (
                                <div className="nav-right-dropdown-menu">
                                    ...
                                    <div className="nav-right-dropdown-item">
                                        <ExitToAppIcon />
                                        <a style={{ cursor: 'pointer' }} onClick={handleLogout} className="nav-right-dropdown-item">
                                            Logout
                                        </a>
                                    </div>
                                </div>
